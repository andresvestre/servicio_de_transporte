...
COMMENT ON TABLE seguridad."rol" IS 'Almacena los roles del usuario';
COMMENT ON COLUMN seguridad.rol.id IS 'Identificador del rol';
...
CREATE TABLE seguridad.usuario (
	...
	nombre varchar(100) DEFAULT '0' NOT NULL,
	apellido varchar(100) DEFAULT '0' NOT NULL,
	correo varchar(250) DEFAULT '0' NOT NULL,
	"password" varchar(250) DEFAULT '0' NOT NULL,
